        ...
        <div data-ha="theme-PurpleHeart" className="svgstroke-a auth bg-gradient">  
            <main className="container-fluid px-0">
                ...
                <div className="px-xl-5 px-4 auth-header" data-bs-theme="none">
                    <Link to="/index" className="brand-icon text-decoration-none d-flex align-items-center" title="ControlHub Admin Template">
                        ...
                        <span className="fw-bold ps-2 fs-5 text-gradient">ControLHUB</span>
                    </Link>
                </div>
                ...
                <footer className="px-xl-5 px-4">
                    ...
                    <p className="mb-0 text-muted">© 2024 <a href="#" target="_blank" title="controlhub">ControlHub</a>, All Rights Reserved.</p>
                </footer>
