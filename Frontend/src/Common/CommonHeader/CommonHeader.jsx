...
import logo from '../../assets/images/xs/logo.png'
      ...
      <header className="px-xl-5 px-lg-4 px-3 sticky-top" id='headerDark' data-bs-theme="none">
          <div className="d-flex justify-content-between align-items-center py-2 w-100">
              <div className="d-flex align-items-center pe-4">
                ...
                <Link to="/" className="brand-icon text-decoration-none d-flex align-items-center" title="ControlHub Admin Template">
                                ...
                                <li className="pe-2">
                                    <a className="d-flex p-lg-3 p-2 rounded-3" href="#">
                                        ...
                                        <div className="flex-fill ms-3">
                                            ...
                                            <p className="mb-0 mt-1">ControlHub admin template on website analytics configurations</p>
                                        </div>
                                    </a>
                                </li>
                            </ul>
