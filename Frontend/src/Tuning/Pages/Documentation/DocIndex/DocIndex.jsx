    ...
    <div className="content px-xl-5 px-lg-4 px-3 py-3 page-body bg-card">
        <div className="row">
            <div className="col-12">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="lead">ControlHub is carefully well thought UI frame work that is built on top of React & Bootstrap5, This part of the doc will help you to quickly start your project and will you a basic idea about how ControlHub work.</p>
            ...
            <div className="col-12">
                ...
                <div className="card">
                    <div className="card-header">
                        <h4>ControlHub Template References</h4>
                    </div>
                    <div className="card-body">
