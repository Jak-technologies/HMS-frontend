            ...
            <form>
                <ul className="row g-3 list-unstyled li_animate">
                    ...
                    <li className="col-12">
                        ...
                        <input type="email" className="form-control form-control-lg" placeholder="" defaultValue="admin@controlhub.com"/>
                    </li>
                    <li className="col-12">
                        ...
                        <input type="password" className="form-control form-control-lg" placeholder="" defaultValue="admin.controlhub"/>
                    </li>
                    <li className="col-12">
                    ...
                    <li className="col-12 text-center">
                        <span className="text-muted d-flex d-sm-inline-flex">New to ControlHub <Link className="ms-2" to="/signup" title="">Sign up here</Link></span>
                    </li>
                </ul>
            </form>
        </div>
